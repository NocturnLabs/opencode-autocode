# Recovery Module (Stuck Protocol)

Read this module when you've failed 3+ times on the same feature.
...
3. **RESEARCH** - Use ALL available tools:
   - **Code Search**: Search codebase (grep, osgrep)
   - **Documentation**: Look up official docs
   - **Web Search**: Search for similar issues
...
Pick an approach that is **NOT** a variation of what you already tried.

---

## If Still Stuck After 3 Different Approaches

Document everything and **move to the next feature**:
...
Then pick the next highest-priority feature with `passes = 0` and continue.

---

## Signs You Are Stuck (Trigger This Protocol Immediately)
